...
export function parseStaffListParams(sp: Pick<URLSearchParams, "get">): StaffListUrlState {
...
export function stringifyStaffListParams(state: StaffListUrlState): string {
