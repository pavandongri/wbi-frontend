...
export type StaffTableSectionProps = {
  rows: UserRow[];
  total: number;
  page: number;
  limit: number;
...
function StaffTableSectionComponent({
  rows,
  total,
  page,
  limit,
              ...
              <TableRow>
                <TableCell colSpan={HEAD.length + 1} sx={{ py: 7, border: 0 }}>
                  <Typography
                    ...
                    fontWeight={600}
                  >
                    No staff members match your filters yet.
                  </Typography>
                </TableCell>
              </TableRow>
            ) : null}
...
export default memo(StaffTableSectionComponent);
