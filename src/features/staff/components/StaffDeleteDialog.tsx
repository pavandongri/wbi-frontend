...
function StaffDeleteDialogComponent({
  open,
  user,
  isPending,
  onClose,
  ...
  return (
    ...
    >
      <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.7 }}>
        ...
        ({user?.email}). They will lose workspace access immediately, and the audit trail keeps the
...
export default memo(StaffDeleteDialogComponent);
